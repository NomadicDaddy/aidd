...
Report weight by type — JS, CSS, fonts, images, media — for the artifact as a whole and for the first page load specifically. JS is the type most reports measure; it is routinely not the largest.
