...
- [ ] WebSocket upgrades repeat the authorization predicate and enforce origin independently.
- [ ] Token comparison is timing-safe and rejects missing or unequal-length values.
- [ ] At least five mandatory falsification outcomes include their deciding `file:line`.
...
- The completed report with at least five concrete falsification outcomes.
