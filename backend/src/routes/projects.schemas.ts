...
import { findingDismissalReasons } from 'aidd-shared/contracts/finding-dispositions';
...
export const featureDismissalBody = t.Object({
	note: t.Optional(t.String({ maxLength: 5000 })),
	reason: literalUnion(findingDismissalReasons),
});
...
export const projectImportBody = t.Object({
	...
	model: t.Optional(t.String({ maxLength: 200, pattern: SAFE_BACKEND_ARG_PATTERN })),
