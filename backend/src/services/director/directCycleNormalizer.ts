...
export function buildDirectCyclePrompt(
	...
	return [
		...
		'Project-specific suggestions must copy a project slug verbatim from fleetSummary.projects[].slug (or the projectId of the prioritizedWork item they came from). A slug may carry a "~" disambiguator because two checkouts share a folder name — keep it; the bare folder name identifies neither of them. Fleet-wide suggestions use null.',
