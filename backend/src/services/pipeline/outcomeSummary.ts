...
// Collapses the attempts at one logical step to the attempt that decided it. Every attempt is
// persisted now, so a step that failed and was retried into a success leaves a 'failed' row behind;
