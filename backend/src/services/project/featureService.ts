...
import type { FeatureApprovalInput, FindingDismissalInput } from './types.ts';

import {
	deleteFeature as deleteFeatureInternal,
	dismissFeature as dismissFeatureInternal,
} from './featureDispositions.ts';
import {
...
export class ProjectFeatureService {
	...
	async dismissFeature(
		...
		return dismissFeatureInternal(this.context(), projectId, featureDirectory, input);
	}
