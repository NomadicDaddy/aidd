...
/**
 * Keys this module adds to a feature from roadmap.json. They describe where the record sits in
 * the plan; they are not fields of the record, and nothing writes them back to feature.json.
 *
 * Exported so a surface showing a feature's on-disk JSON can strip exactly what the API added,
 * rather than keeping its own guess at the list.
 */
export const ROADMAP_DERIVED_FEATURE_KEYS: readonly string[] = ['milestone'];
