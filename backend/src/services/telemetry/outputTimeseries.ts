...
// bucketing keeps the shape consistent with aggregation.ts getTimeseries. NULL metrics (runs with
// none captured, commit-less runs) are excluded from the sums but still counted in `runs`, with
