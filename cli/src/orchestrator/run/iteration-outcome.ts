...
//
// runtime/ is excluded wholesale for the opposite reason: nothing a user authored lives there. Its
// pipeline session metrics are rewritten after every step, reinstating the always-true check.
...
// Session metrics files that land in reports/ instead of runtime/; the boot sweep collects them.
