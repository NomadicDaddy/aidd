...
export async function handlePostIteration(input: {
	...
	events: AgentEvent[];
	exitCode: number;
	/** The iteration-start feature inventory, forwarded to the leased-feature deletion guard so it
	 * can prove a record disappeared instead of inferring it from absence. */
