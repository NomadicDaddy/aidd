...
// 0 without emitting a non-empty planMarkdown produced no plan. A fallback to raw
// assistant prose would let refusals, tool narration, or an empty transcript become the
// "approved" implementation plan — worst on the complexity fast path, where that text would go
