...
| ------------------------------------ | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `CONTEXT.md`                         | required    | External `grill-with-docs` skill from the canonical AI catalog (`<applications-root>/ai/skills/grill-with-docs`)                                                                                                                                 |
...
| `.aidd/roadmap.json`                 | recommended | `skill:update-roadmap {app}` and `aidd-tools roadmap:apply --project-dir`                                                                                                                                                                        |
...
| `.aidd/project-profile.json`         | recommended | Web maturity flow or explicit assurance-profile edit                                                                                                                                                                                             |
...
| `.aidd/features/*/feature.json`      | tracked     | `skill:feature-review`, `skill:bug2feature`, `skill:doc2feature`                                                                                                                                                                                 |
| `.aidd/deployment.md`                | tracked     | `skill:deployment-readiness {app}` (maturity `shipped` stage)                                                                                                                                                                                    |
| `.aidd/CHANGELOG.md`                 | tracked     | `skill:document-changes`, coding sessions                                                                                                                                                                                                        |
...
| `.aidd/audit-reports/*.md`           | generated   | audit runs and `writeAuditReport`; re-runnable per audit                                                                                                                                                                                         |
