...
function ResizeHandle() {
	...
	return (
		<div
			...
			role="separator">
			<div className="mx-auto mt-1 h-0.5 w-full bg-transparent transition-colors group-hover:bg-accent/70" />
		</div>
	);
}
...
export function TerminalPane() {
	...
	return (
		<section
			aria-label="Terminal"
			className={cn(
				'fixed right-0 bottom-0 z-30 flex flex-col border-t border-border bg-background shadow-[0_-8px_24px_-12px_rgba(2,6,23,0.35)]',
