...
interface BadgeProps extends HTMLAttributes<HTMLSpanElement> {
	...
	showDot?: boolean;
	/** The status assertion declared by `lib/tones.ts`; identity and taxonomy stay neutral. */
	tone?: Tone;
}
	...
	return (
		<span
			className={cn(
				...
				'focus-visible:ring-2 focus-visible:ring-ring/80 focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none focus-visible:[--tw-ring-inset:initial]',
				toneBadge[tone],
				'font-sans tracking-normal',
				casing === 'title' ? 'capitalize' : 'normal-case',
				className,
			)}
			ref={ref}
			{...props}>
