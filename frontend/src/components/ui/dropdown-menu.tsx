...
import { toneSurfaceFocus, toneSurfaceHover, toneText } from '../../lib/tones.ts';
...
const toneClass = {
	danger: cn(toneText.red, toneSurfaceFocus.red, toneSurfaceHover.red),
	neutral: 'text-foreground hover:bg-muted focus:bg-muted',
};
		...
		<div className={cn('relative inline-flex', className)}>
			...
			{open && (
				<div
					...
					className={cn(
						'absolute top-full z-20 mt-1 w-44 overflow-hidden rounded-md border border-border bg-card py-1 text-card-foreground shadow-lg outline-none',
