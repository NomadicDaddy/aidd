...
// Branches, tags, stashes, and worktrees are git refs metadata — cached separately from the
// stats payload for the same reason. They change infrequently so a 60-second stale window is
// sufficient.
