...
const pillClassName =
	'inline-flex items-center rounded-full border border-teal-300 bg-white px-2 py-0.5 text-teal-700 shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-teal-400 dark:border-teal-700 dark:bg-slate-950 dark:text-teal-300';
