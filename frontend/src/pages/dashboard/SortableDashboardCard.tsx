...
const pillClassName =
	'inline-flex items-center rounded-full border border-cyan-300 bg-white px-2 py-0.5 text-cyan-700 shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 dark:border-cyan-700 dark:bg-slate-950 dark:text-cyan-300';
	...
	return (
		<div
			className={cn(
				...
				!locked &&
					'cursor-grab outline-2 outline-offset-2 outline-cyan-400/60 outline-dashed active:cursor-grabbing',
