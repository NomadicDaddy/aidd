...
function CycleArtifactRow({
	...
	return (
		<div className="min-w-0 rounded-md border border-border p-2">
			...
			<FilePath className="mt-1 block truncate text-2xs text-muted-foreground" path={path} />
		</div>
	);
}

export function ActiveCycleLoading() {
	return (
		<div
			aria-busy="true"
			aria-live="polite"
			className="mt-4 min-h-40 space-y-3 rounded-md border border-border bg-muted p-3">
			<span className="sr-only">Loading active cycle…</span>
