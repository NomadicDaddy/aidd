...
export function GithubRepoField({ source }: { source: GithubTemplateSourceState }) {
	return (
		<FieldRow
			error={source.urlError}
			hint="Cloned as a template: history is stripped and a fresh git repo is initialized."
...
export function ProjectTemplatePicker({
	...
	return (
		<FieldRow hint={selectedTemplate?.description} label="Template">
			<select
