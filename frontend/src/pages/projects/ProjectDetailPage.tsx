...
export function ProjectDetailPage() {
	...
	const interviewDrafts = useInterviewDrafts(project.data?.id);
	useCanonicalProjectRoute(params.id, canonicalRouteId);
	const tab = useProjectDetailTab(searchParams, setSearchParams);
	...
	return (
		<PageRail className="page-reveal @container space-y-5" rail={PAGE_RAIL}>
			<PageHeader
				...
				title={detail.name}
			/>
			<div className={tab === 'audits' ? tableColumnClass : undefined}>
