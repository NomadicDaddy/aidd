		...
		<div className="grid gap-4 lg:grid-cols-3">
			...
			<Link
				...
				<Metric
					...
					detail={
						check
							? `${artifactTotal} artifacts · ${check.summary.fresh} fresh · ${check.summary.stale} stale · ${check.summary.missing} missing`
					...
					value={humanizeEnum(project.artifactHealth)}
				/>
			</Link>
		</div>
	);
