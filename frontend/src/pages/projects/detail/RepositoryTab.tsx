		...
		<div className="space-y-4">
			...
			{refsQuery.isLoading ? (
				<Card aria-busy="true">
					<SkeletonLines
						count={4}
						label="Reading branches, tags, stashes, and worktrees…"
					/>
				</Card>
			  ...
			  refsQuery.data.refs ? (
				<RepositoryRefsCard
					...
					remoteBranchCount={
						query.data?.state === 'ok' && query.data.info
							? query.data.info.remoteBranches
							: undefined
					}
					stashes={refsQuery.data.refs.stashes}
					tags={refsQuery.data.refs.tags}
					totalTagCount={
						query.data?.state === 'ok' && query.data.info
							? query.data.info.tags
							: undefined
					}
