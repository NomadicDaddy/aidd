...
export interface ArtifactInventoryGroup {
...
/** Whether a human label says anything its machine identifier does not. */
export function labelAddsNothing(identifier: string, label: string | undefined): boolean {
