...
/**
 * How many children one directory renders before it is summarised. The cap is per directory, applied
 * after the tree is built: capping the flat file list *before* building it would leave any file past
 * the cap viewable from a link but with no row to select or highlight — the tree and the viewer
 * showing different worlds.
 */
