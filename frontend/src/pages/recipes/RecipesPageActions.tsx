...
export function RecipesPageActions({
	...
	return (
		...
		<div className="flex shrink-0 flex-nowrap items-center gap-2">
			<Button aria-label="New Recipe" onClick={onNew} size="default" variant="primary">
			...
			{/* `max-sm:w-auto`, because `SegmentedControl` is `w-full` below `sm` and this row is
			    ...
			    twice attributed to the sidebar. An unprefixed `w-auto` does not override the
			    component's variant-specific `max-sm:w-full`; the matching modifier has to own the
			    phone width.
			...
			<SegmentedControl
				...
				options={[
					{
						ariaLabel: 'Card view',
						label: <Grid2X2 aria-hidden="true" className="h-4 w-4" />,
						title: 'Card view',
						value: 'cards',
					},
					{
