 ...
 * which is the point. A summary that asked for a whole recipe would be view-mode-only, and a recipe
 * is the one thing the edit form does not have until Save succeeds.
 */
