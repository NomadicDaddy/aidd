 ...
 *
 * The glyph is the point. As a red sentence among grey ones, the only thing separating "this is
 * what went wrong" from "this is more step detail" would be the tone — and a reader who cannot
 * tell that red from the muted grey beside it would be looking at an unlabelled paragraph.
 ...
 *
 * One declaration serves three surfaces (session row, step table row, step sub-row). Each now
 * imports the same semantic failure foreground from the tone layer.
 */
