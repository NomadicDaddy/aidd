...
export function LiveConsole({
	...
	return (
		...
		// calc() subtraction.
		<section className="flex min-h-0 flex-col @min-[81.25rem]:flex-1">
				...
				{consoleOpen ? (
					<div className="relative flex min-h-0 flex-1 flex-col">
						...
						<div
							...
							className="h-[min(560px,45vh)] w-full max-w-full overflow-auto rounded-lg border border-border bg-background p-4 text-xs leading-relaxed text-foreground shadow-inner @min-[81.25rem]:h-auto @min-[81.25rem]:min-h-[27rem] @min-[81.25rem]:flex-1"
