...
// Three type steps, not four invented pixel sizes rendered all at once (in the open transcript at
// 2250 that would be 62 spans at 10px, 61 summaries and 61 pre blocks at 11px, 65 code spans at
// 12px and 20 paragraphs at 13px). `--text-2xs` (11px) exists as the deliberate extra step for
// exactly the count-chip and keycap role the `ok` chip fills, so everything sits on three real
// steps: 2xs for the chips and the folded output, xs for the command line and reasoning, sm for
// assistant prose.
		...
		<div className="rounded-md border border-border bg-muted">
			...
			{entry.output ? (
				<details className="group border-t border-border">
					<summary className="flex cursor-pointer list-none items-center gap-1 px-2.5 py-1 text-2xs text-muted-foreground select-none marker:content-none hover:text-foreground">
						<DisclosureMarker />
