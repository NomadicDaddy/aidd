...
export interface UnifiedExecutionTableProps {
	...
	/**
	 * Rendered inside the Card below the body. History uses the shared pagination footer so its
	 * navigation and visible-range summary remain attached to the entries they control.
	 */
	footer?: ReactNode;
