 ...
 * to show; the display name is a gloss on it.
 *
 * It then spent a revision on a native `title`, which is the mechanism the badge component's own
 * source comment explains why it abandoned: mouse-only, so unreachable by keyboard and by touch,
 * and a second reveal mechanism on a sheet that already ships `ui/tooltip`. It now goes through the
 * `hint` prop and lands in the same details panel every other specimen uses.
 */
