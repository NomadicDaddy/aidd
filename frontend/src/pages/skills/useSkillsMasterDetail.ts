...
export function useSkillsMasterDetail(
	...
	const catalogScrollYRef = useRef<null | number>(null);
	...
	function showCatalog(id: string): void {
		...
		requestAnimationFrame(() => {
			const returnScrollY = catalogScrollYRef.current;
			if (returnScrollY !== null) window.scrollTo({ behavior: 'auto', top: returnScrollY });
