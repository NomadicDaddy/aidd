...
- `/.aidd/status.md` - Auto-generated by `--status` and before each iteration
...
- Use `/.aidd/features/*/feature.json` to update feature status
- Use `/.aidd/CHANGELOG.md` for documenting progress
- Use `/.aidd/todo.md` for tracking work items
