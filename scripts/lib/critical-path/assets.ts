...
export function sizeOf(assetName: string): CriticalAsset {
...
export function staticImportsOf(entryName: string): string[] {
...
export function findReactRuntimeChunk(): null | string {
