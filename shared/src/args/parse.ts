 ...
 * what it finds — so a bare `aidd --skill spirit` would otherwise edit the tree with nothing having
 * asked it to. `--directive-readonly` works on its own; the validator rejects it alongside an
