import type { AiddRunDriverKind } from '../run-provenance.ts';
...
export interface RunDriverPlan {
...
export interface PromptPlan {
	 ...
	 * summaries can say "skill 'review-or-create-doc'" instead of the generic "directive run", matching
