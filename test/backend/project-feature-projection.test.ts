...
// The project-detail response used to carry every feature in full: for this repository that was
// 2.07 MB of `features` inside a 2.23 MB response, 83% of it prose that no tab reads in bulk.
