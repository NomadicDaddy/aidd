...
describe('post-iteration feature contract check', () => {
	// The loop the skills used to close by running `--check-features` mid-run: aidd validates the
	// collection itself now, and the agent has to see the result while it can still act on it.
