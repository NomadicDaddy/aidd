...
// Drift check for docs/reference/recipes.md. The doc is hand-curated (it carries prose
...
const docPath = join(repoRoot, 'docs', 'reference', 'recipes.md');
...
describe('docs/reference/recipes.md stays in sync with recipes/*.json', () => {
