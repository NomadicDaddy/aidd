...
function renderEnumLabels(): Record<string, string> {
	const script = [
		...
		' isDimmed: false, isRelated: false, isSelected: false, node, onSelect: noop,',
		'});',
		'console.log(JSON.stringify({',
		' dependencyFilters: renderToStaticMarkup(dependencyFilters),',
		' featureFilters: renderToStaticMarkup(featureFilters),',
